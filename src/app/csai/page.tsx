...
/* ══════════════════════════════════════════════
   CSAI Case Study — case-study.ibrahim-eng.dev/csai
   ══════════════════════════════════════════════ */
...
export default function CSAICaseStudy() {
  return (
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-border shadow-card">
              ...
              <div className="relative aspect-[16/9] overflow-hidden">
                <Image src="/images/projects/csai.jpg" alt="Customer Service AI — screenshot" fill className="object-cover object-top" sizes="(max-width:768px) 100vw,800px" priority />
        ...
        >
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-800/50 border border-gray-700 text-gray-400 text-xs font-medium mb-6">
              <span>⚠️</span>
              <span>CSAI is no longer available — domain and hosting shut down</span>
            </div>
            ...
            <p className="text-muted mt-2 sm:mt-3 text-xs sm:text-sm max-w-md mx-auto">
              This project was the foundation. It has since been rebuilt as
              Chat Mart — a full SaaS platform with 7 channels, 1000+ Kurdish voices, and its own domain.
            </p>
